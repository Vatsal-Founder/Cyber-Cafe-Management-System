                            ...
                            <div class="col-12">
                                <div class="card-box">
                                       ...
                                       <div class="form-group row">
                                                        <label class="col-4 col-form-label" for="example-email" style="padding-left: 50px"><strong>Entry ID Proof</strong></label>
                                                        <div class="col-6">
                                                   ...
                                                   <div class="card-footer">
                                                       <p style="text-align: center;"><button type="submit" class="btn btn-primary btn-sm" name="search" id="submit">
                                                         <li><a href="manage-newusers.php" style="color: white">Search</a></li>
                                                        </button></p>
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
                  ...
                  <th>Entry ID</th>
                   ...
                   <th>Action</th>
                                    ...
                                    <?php
$ret=mysqli_query($con,"select *from tblusers where IDProof like '%$sdata%' || UserName like  '%$sdata%' ");
...
while ($row=mysqli_fetch_array($ret)) {
    ?>
                ...
                <tr>
                  ...
                  <td><a href="view-user-detail.php?upid=<?php echo $row['ID'];?>">Update</a></td>
                </tr>
                 <?php 
$cnt=$cnt+1;
} } else { ?>
